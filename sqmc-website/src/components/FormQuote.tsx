        ...
        <>
            <div className="hero max-w-screen-2xl mx-auto bg-gradient-to-b from-slate-900 to-white bg-opacity-10 rounded-xl">
                ...
                <div className="flex flex-col w-full">
                    <h1 className="text-white text-lg md:text-xl lg:text-2xl font-bold my-10 mx-10 text-center">Ready to elevate your business to the next level? Elevate your business with our tailored certification solutions. Get a free quote today by filling out the form below and take the first step towards certification excellence.</h1>
                                ...
                                {(props) => (
                                    <Form className="">
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                            ...
                                            <div className="form-control">
                                                <label className="label" htmlFor="selectedservicestags">
                                                    <span className="label-text">Type of Service(s)</span>
                                                </label>
                                                {props.errors.selectedservicestags && props.touched.selectedservicestags ?
                                                    <>
                                                        <Select
                                                            id="selectedservicestags"
                                                            instanceId="selectedservicestags"
                                                            isMulti
                                                            options={serviceTagOptions.map((tag) => ({
                                                                value: tag.key,
                                                                label: tag.key,
                                                                ...tag
                                                            }))}
                                                            ...
                                                            onChange={(tags) => props.setFieldValue('selectedservicestags', tags.map(tag => tag.value))}
                                                        />
                                                        <div className="ml-1 text-sm text-red-500">{props.errors.selectedservicestags}</div>
                                                    </> : <Select
                                                        id="selectedservicestags"
                                                        instanceId="selectedservicestags"
                                                        isMulti
                                            ...
                                            <div className="form-control">
                                                <label className="label" htmlFor="selectedcertificatetags">
                                                    <span className="label-text">Type of Certification(s)</span>
                                                </label>
                                                {props.errors.selectedcertificatetags && props.touched.selectedcertificatetags ?
                                                    <>
                                                        <Select
                                                            id="selectedcertificatetags"
                                                            instanceId="selectedcertificatetags"
                                                            isMulti
                                                            options={certificatetagOptions.map((tag) => ({
                                                                value: tag.key,
                                                                label: tag.key,
                                                                ...tag
                                                            }))}
                                                            ...
                                                            onChange={(tags) => props.setFieldValue('selectedcertificatetags', tags.map(tag => tag.value))}
                                                        />
                                                        <div className="ml-1 text-sm text-red-500">{props.errors.selectedcertificatetags}</div>
                                                    </> : <Select
                                                        id="selectedcertificatetags"
                                                        instanceId="selectedcertificatetags"
                                                        isMulti
