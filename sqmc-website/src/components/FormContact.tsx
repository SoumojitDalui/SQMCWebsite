        ...
        <>
            <div className="hero max-w-screen-2xl mx-auto bg-gradient-to-b from-slate-900 to-white bg-opacity-10 rounded-xl">
                ...
                <div className="flex flex-col w-full">
                    <h1 className="text-white text-2xl md:text-3xl lg:text-4xl font-bold my-10 mx-10 text-center">Please use the form below to send us a message, and a representative from our team will be in touch shortly to assist you.</h1>
